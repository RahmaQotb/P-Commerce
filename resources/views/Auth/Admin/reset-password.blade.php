...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('admin.reset.passwordPost') }}">
              
                @csrf
                <input type="text" hidden name="token" value="{{$token}}">
              
                <div class="form-group position-relative has-icon-left mb-4">
                    <input class="form-control form-control-xl" name="email" type="email" id="email" placeholder="Email">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="password" id="password_confirmation" class="form-control form-control-xl" name="password_confirmation" placeholder="Confirm Password">
