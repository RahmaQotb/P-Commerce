...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('admin.forget.passwordPost') }}">
                @csrf
...
<p class="text-gray-600">Remember your account? <a href="{{route("admin.login")}}" class="font-bold">Log in</a>.</p>
                </p>
            </div>
        </div>
    </div>
