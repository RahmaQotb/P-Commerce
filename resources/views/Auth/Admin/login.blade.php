        ...
        <div id="auth-left">
            ...
            <form method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input class="form-control form-control-xl" name="email" :value="old('email')"  autofocus type="email" id="email" placeholder="Email">
                ...
                <x-primary-button style="background-color: #435ebe" class="ms-3">
                    {{ __('Log in') }}
                </x-primary-button>
            </form>
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600">Don't have an account? <a href="{{route('admin.register')}}" class="font-bold">Sign
                        up</a>.</p>
                        <p><a class="font-bold" href="{{route("admin.forget.password")}}">Forgot password?</a>.</p>
