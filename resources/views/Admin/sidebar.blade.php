    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('assets/assets/compiled/svg/logo.svg') }}" alt="Logo"
                            srcset=""></a>
                </div>
            ...
            <ul class="menu">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <form method="POST" action="{{ route('admin.change.password') }}">
                                @csrf
                                <a href="{{ url('admin/profile/change-password') }}" class="submenu-link"
                                    style="background: none; border: none; padding: 1; cursor: pointer;" type="Submit">
                                    {{-- <i class="bi bi-grid-fill"></i> --}}
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item">
                            <a href="{{url('admin/products/create')}}" class="submenu-link">Add Product</a>
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item  ">
                            <a href="{{ url('admin/categories') }}" class="submenu-link">All Categories </a>
