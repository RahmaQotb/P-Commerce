...
<ul class="menu">
    ...
    <li
        ...
        <a href="{{url ("admin/profile/change-password")}}" class='sidebar-link'>
        ...
        <form method="POST" action="{{route('admin.change.password')}}">
            @csrf
        <a href="{{url ("admin/profile/change-password") }}" class='sidebar-link' type="Submit" >
            <i class="bi bi-grid-fill"></i>
    ...
    <form method="POST" action="{{ route('admin.logout') }}">
        @csrf
    <a href="{{url ("admin/logout") }}" class='sidebar-link' type="Submit" >
        <i class="bi bi-grid-fill"></i>
        <span>Logout</span>
    </a>
    </form>
