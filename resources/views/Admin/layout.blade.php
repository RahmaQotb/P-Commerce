...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
    ...
    <link id="app-css" rel="stylesheet"
        href="{{ session('locale', 'en') == 'ar' ? asset('assets/Admin/compiled/css/app.rtl.css') : asset('assets/Admin/compiled/css/app.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/Admin/extensions/sweetalert2/sweetalert2.min.css') }}">
    <link id="app-css" rel="stylesheet"
        href="{{ session('locale', 'en') == 'ar' ? asset('assets/Admin/compiled/css/app-dark.rtl.css') : asset('assets/Admin/compiled/css/app-dark.css') }}" />
    <link id="app-css" rel="stylesheet"
        href="{{ session('locale', 'en') == 'ar' ? asset('assets/Admin/compiled/css/iconly.rtl.css') : asset('assets/Admin/compiled/css/iconly.css') }}" />
...
<body>
    ...
    <script src="{{ asset('assets/admin/extensions/jquery/jquery.js') }}"></script>
